...
ratioSlider(nullptr, "")
{
    ...
    addLabelPairs(thresholdSlider.labels, getParamHelper(Names::Threshold_Mid_Band), "ms");
    ...
    auto makeAttachmentHelper = [&params, &apvts = this->apvts](
        auto& attachment,
        const auto& name,
        auto& slider
        )
...
GlobalControls::GlobalControls(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    auto makeAttachmentHelper = [&params, &apvts](
        auto& attachment, 
        const auto& name, 
        auto& slider
    )
